    ...
    <section id='contatti' className='w-screen p-20  flex flex-col items-center gap-9 max-sm:p-10 max-sm:gap-6 max-md:items-start '>
        ...
        <form  onSubmit={handleSubmit} className='mt-10 flex flex-col gap-4 items-center w-4/5 max-md:w-full max-md:items-start '>
            <div className='w-full flex justify-center  gap-9  max-md:flex-wrap max-md:gap-4'>
                <input type="text" placeholder='Name' required className='bg-transparent border-b border-white py-2 text-sm w-1/2 max-md:w-full' onChange={(e)=>{setName(e.target.value)}}/>
                <input type="text" placeholder='Last Name'required className='bg-transparent border-b border-white py-2 text-sm  w-1/2 max-md:w-full ' onChange={(e)=>{setLastName(e.target.value)}} />
            </div>
            <div className='w-full flex  justify-between gap-9 max-md:flex-wrap max-md:gap-4'>
                <input type="email" placeholder='Email' required className='bg-transparent border-b border-white py-2 text-sm  w-1/2 max-md:w-full' onChange={(e)=>{setEmail(e.target.value)}}/>
                <input type="tel" placeholder='Phone number' required className='bg-transparent border-b border-white py-2 text-sm  w-1/2  max-md:w-full' onChange={(e)=>{setTelephone(e.target.value)}}/>
            </div>
